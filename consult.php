...
<html lang="fr">
    <head>
        ...
        <title>Jeunes 6.4 - Consultation profil</title>
                ...
                <?php
                    ...
                    if(isset($userData['references']) && !empty($userData['references'])) {
                        ...
                        foreach ($references as $key => $reference) {
                            ...
                            $refBirth_formattee = utf8_encode(strftime("%d %B %Y", strtotime($refBirth)));
                                    ...
                                    <div class="two-columns">
                                        ...
                                        <div class="column referent">
                                            ...
                                            <div class="ref-info">
                                                ...
                                                <span><i class="fa-solid fa-phone color-icn"></i> <?php echo implode('.', str_split($reference['tel'], 2)); ?></span>
                                            </div>
                                            <span></span>
                                        </div>
                                    </div>
